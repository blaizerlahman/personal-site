<script>
	...
	function pulse() {
		...
		direction = 1 - direction;    // flip direction of animation
...
<main class="flex flex-col flex-1">
	<section class="flex flex-col md:flex-row items-center gap-52 py-24
		...
		<div class="flex-1 space-y-6 text-left">
			...
			<ul class="list-none pl-7 space-y-2 text-2xl relative">
				<li class="pl-0 before:content-['—'] before:absolute before:-left-1
		  	   before:text-violet-600 before:text-3xl before:leading-none before:font-mono share-tech-mono">Fullstack&nbsp;Developer</li>
				<li class="pl-0 before:content-['—'] before:absolute before:-left-1
			   before:text-violet-600 before:text-3xl before:leading-none before:font-mono teko">DATA_WRANGLER</li>
				<li class="pl-0 before:content-['—'] before:absolute before:-left-1
			   before:text-violet-600 before:text-3xl before:leading-none before:font-mono dot-gothic">0xcyberdabbler</li>
			</ul>
			<button
		...
		<div class="blob-container relative shrink-0
		            w-[18rem] h-[18rem] md:w-[20rem] md:h-[20rem] mx-auto">

			<!-- glow around headshot -->
			<div class="blob-background absolute inset-0 -z-20 w-full h-full rounded-full
